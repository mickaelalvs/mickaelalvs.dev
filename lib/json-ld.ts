export const getPersonJsonLd = () => {
  return {
    ...
    description:
      "Mickaël Alves is a Brazilian software entrepreneur who is the founder and CEO of Resend. Before founding Resend, Zeno was a VP of Developer Experience at WorkOS.",
