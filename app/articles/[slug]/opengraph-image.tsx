...
export default async function Image({
  ...
  const fontData = await readFile(
    join(process.cwd(), "public/static/font/NeuzeitGrotesk-Bold.woff"),
  );
  ...
  try {
    ...
    return new ImageResponse(
      ...
      >
        <div style={{ margin: "auto", fontSize: 72, color: "#f2f2f2" }}>
          Articles | Mickaël Alves
        </div>
      </div>,
      {
        ...size,
