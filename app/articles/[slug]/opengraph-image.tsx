...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
    ...
    try {
        ...
        return new ImageResponse((
            <div style={{ height: '100%', width: '100%', display: 'flex', backgroundColor: '#08070b', fontFamily: 'Neuzeit Grotesk Bold' }}><div style={{ margin: 'auto', fontSize: 72, color: '#f2f2f2' }}>Articles | Mickaël Alves</div></div>
        ), { ...size, fonts: [{ name: 'Neuzeit Grotesk Bold', data: fontData, style: 'normal', weight: 700 }] });
    }
}
