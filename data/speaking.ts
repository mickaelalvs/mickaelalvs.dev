...
} from './speaking/remotion-le-7eme-art-a-portee-de-composants-web-et-dapi';
...
} from './speaking/jadore-les-developpeurs-dans-2-3-ans-il-y-en-aura-plus';
...
} from './speaking/les-coulisses-de-javascript-ce-quon-utilise-sans-comprendre';
import {
  RevolutionTanStackQueryEnfinUneBonneGestionDetat,
} from './speaking/revolution-tanstack-query-enfin-une-bonne-gestion-detat';
import {
  LeMagicienZodEmmenezTypeScriptAuDelaDuBuild,
} from './speaking/le-magicien-zod-emmenez-typescript-au-dela-du-build';
