...
export default function PodcastsPage() {
  ...
  return (
    ...
    >
      <LayoutGroup>
        <p>
          Audio is a powerful medium and a great way to{" "}
          <strong>debate ideas</strong>. I love exchanging ideas with people and
          have had the opportunity to organize or participate in various
          podcasts. But sharing is even better around a table with{" "}
          <strong>amazing guests</strong>.
        </p>
