...
<figure>
  <img src="/static/images/articles/switching-from-babel-to-swc/babel-process.png" class="post-image-full" alt="Scripts execute during render phase too" style="border-radius: 16px;">
</figure>
...
<figure>
  <img src="/static/images/articles/switching-from-babel-to-swc/final-process.png" class="post-image-full" alt="Scripts execute during render phase too" style="border-radius: 16px;">
</figure>
...
<div class="side-by-side" style="justify-content: center; gap: 20px;">
  <figure>
    <img src="/static/images/articles/switching-from-babel-to-swc/build-performance.png" class="side-by-side-img" alt="Build performance benchmark" style="border-radius: 16px;">
  </figure>
  <figure>
    <img src="/static/images/articles/switching-from-babel-to-swc/dev-build-performance.png" class="side-by-side-img" alt="Dev build performance benchmark" style="border-radius: 16px;">
  </figure>
</div>
...
<div class="side-by-side" style="justify-content: center; gap: 20px;">
  <figure>
    <img src="/static/images/articles/switching-from-babel-to-swc/bundle-size.png" class="side-by-side-img" alt="Bundle size comparison" style="border-radius: 16px;">
  </figure>
  <figure>
    <img src="/static/images/articles/switching-from-babel-to-swc/bundle-analysis.png" class="side-by-side-img" alt="Bundle analysis" style="border-radius: 16px;">
  </figure>
</div>
